...
{
	UABHpBarWidjet* HpBarWidget = Cast<UABHpBarWidjet>(InUserWidget);
	...
	if (HpBarWidget)
	{
		...
		Stat->OnHpChanged.AddUObject(HpBarWidget, &UABHpBarWidjet::UpdateHpBar);
	}
}
