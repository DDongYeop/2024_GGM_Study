...
namespace Server
{
    ...
    public struct FLocation : IPacketSerializable
    {
        ...
        public static FLocation Default => new FLocation { X = 0f, Y = 0f, Z = 0f };
    ...
    public struct PcInfoBr : IPacketSerializable
    {
        ...
        public static PcInfoBr Default =>
            new PcInfoBr
            {
                Index = 0,
    ...
    public struct RemoveBr : IPacketSerializable
    {
        ...
        public static RemoveBr Default => new RemoveBr { Index = 0, ObjectType = default };
    ...
    public struct MoveBr : IPacketSerializable
    {
        ...
        public static MoveBr Default => new MoveBr { Index = 0, ObjectType = default, Pos = default, Dest = default };
