...
public struct AttackResult : IPacketSerializable
{
    ...
    public EObjectType TarObjectType;
    public int TarObjectIndex;
    public int TarDamage;
    public AttackResult(
        EAttackResult result,
        EObjectType tarobjecttype,
        int tarobjectindex,
        int tardamage)
    {
        this.Result = result;
        this.TarObjectType = tarobjecttype;
        this.TarObjectIndex = tarobjectindex;
        this.TarDamage = tardamage;
    }
    public static AttackResult Default => new AttackResult
    {
        Result = default,
        TarObjectType = default,
        TarObjectIndex = 0,
        TarDamage = 0
    };
    public void Serialize(NetBase.PacketBase PacketBase)
    {
        ...
        PacketBase.Write(TarObjectType);
        PacketBase.Write(TarObjectIndex);
        PacketBase.Write(TarDamage);
    }
    public void Deserialize(NetBase.PacketBase PacketBase)
    {
        Result = PacketBase.Read<EAttackResult>();
        TarObjectType = PacketBase.Read<EObjectType>();
        TarObjectIndex = PacketBase.Read<int>();
        TarDamage = PacketBase.Read<int>();
    }
}
...
public struct AttackInfo : IPacketSerializable
{
    ...
    public void Deserialize(NetBase.PacketBase PacketBase)
    {
        ...
        Pos = PacketBase.Read<FLocation>();
        Dest = PacketBase.Read<FLocation>();
        AttackDamage = PacketBase.Read<int>();
...
{
    public EObjectType SrcObjectType;
    ...
    public float TimeOffset;
    public EAttackResult Result;
    public EKillType IsKillType;
    public AttackBr(
        EObjectType srcobjecttype,
        int srcobjectindex,
        EObjectType tarobjecttype,
        int tarobjectindex,
        int skillid,
    ...
    public void Serialize(NetBase.PacketBase PacketBase)
    {
        PacketBase.Write(SrcObjectType);
        ...
        PacketBase.Write(PostHitPosition);
        PacketBase.Write(PostHitDirection);
        PacketBase.Write(Damage);
        PacketBase.Write(TimeOffset);
        PacketBase.Write(Result);
        PacketBase.Write(IsKillType);
    }
    public void Deserialize(NetBase.PacketBase PacketBase)
    {
        SrcObjectType = PacketBase.Read<EObjectType>();
        ...
        PostHitPosition = PacketBase.Read<FLocation>();
        PostHitDirection = PacketBase.Read<float>();
        Damage = PacketBase.Read<int>();
        TimeOffset = PacketBase.Read<float>();
        Result = PacketBase.Read<EAttackResult>();
        IsKillType = PacketBase.Read<EKillType>();
    }
}
